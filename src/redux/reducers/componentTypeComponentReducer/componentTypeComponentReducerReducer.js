...
import { FETCH_COMPONENT_TYPE_COMPONENT_SUCCESS, FETCH_COMPONENT_TYPE_COMPONENT_PROPERTIES_SUCCESS, FETCH_COMPONENT_TYPE_COMPONENT_RELATIONSHIPS } from '../../sagas/componentTypeComponent/componentTypeComponentSaga'
...
export const actions = {
  ...
  FETCH_COMPONENT_TYPE_COMPONENT_RELATIONSHIPS,
  SET_DATA_LOADING,
  SET_CURRENT_PAGE
}
...
export default handleActions(
  {
    ...
    [FETCH_COMPONENT_TYPE_COMPONENT_RELATIONSHIPS]: (state, action) => ({
      ...state,

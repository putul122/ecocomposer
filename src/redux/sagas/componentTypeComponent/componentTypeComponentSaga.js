...
export function * getComponentTypeComponent (action) {
  try {
    const componentTypes = yield call(
      ...
      'https://ecocomposermockapis.azurewebsites.net/ecocomposer-meta-model/component_types/1/components/1'
    )
...
export function * getComponentTypeComponentProperties (action) {
  try {
    const componentTypes = yield call(
      ...
      // api.getComponentTypes,
      // {params: action.payload}
      'https://ecocomposermockapis.azurewebsites.net/ecocomposer-meta-model/component_types/1/properties'
    )
